...
const SvgGetItOnGooglePlayBadgeEN = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    id="GetItOnGooglePlay_Badge_Web_color_English_svg__artwork"
  ...
  >
    <defs>
      <style>
        {
          ".GetItOnGooglePlay_Badge_Web_color_English_svg__st2{stroke:#fff;stroke-miterlimit:10;stroke-width:.2px;fill:#fff}"
        }
      </style>
    </defs>
    <rect width={239.17} height={70.87} x={-0.11} rx={8.86} ry={8.86} />
    <path
...
export default SvgGetItOnGooglePlayBadgeEN;
